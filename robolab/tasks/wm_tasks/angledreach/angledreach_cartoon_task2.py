...
STATUS_PATH = Path(ASSET_DIR) / "wm_tasks" / "AngledReachCartoon2Task" / "status.json"

@configclass
class AngledReachCartoon2Terminations:
...
@dataclass
class AngledReachCartoon2Task(Task):
    contact_object_list = [
        "table",
        "alphabet_soup_can",
        "milk_carton",
    ...
    terminations = AngledReachCartoon2Terminations
    instruction = {
        "default": "AngledReachCartoon2",
