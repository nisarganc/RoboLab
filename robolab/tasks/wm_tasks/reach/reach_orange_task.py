...
STATUS_PATH = Path(ASSET_DIR) / "wm_tasks" / "ReachOrangeTask" / "status.json"


@configclass
class ReachOrangeTerminations:
...
class ReachOrangeTask(Task):
    ...
    terminations = ReachOrangeTerminations
    instruction = {
        "default": "ReachOrange",
        "vague": "Reach the orange",
        "specific": "Move the robot gripper to a position just above the orange without grasping it",
    }
